(function () {
  ...
  const storageKey = "snowpro-signal-studio-v1";
  ...
  function exportProgress() {
    ...
    if (window.navigator.msSaveOrOpenBlob) {
      window.navigator.msSaveOrOpenBlob(blob, "snowpro-progress.json");
      return;
    }
    ...
    link.href = url;
    link.download = `snowpro-progress-${stamp}.json`;
