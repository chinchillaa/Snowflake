...
1. ファイル: `hands-on/dbt/dbt_learn/models/staging/stg_customers_clean.sql` を新規作成
...
```bash
# 1. compile で展開結果を確認
dbt compile --select stg_customers_clean --project-dir hands-on/dbt/dbt_learn
...
# 3. 実行
dbt run --select stg_customers_clean --project-dir hands-on/dbt/dbt_learn
