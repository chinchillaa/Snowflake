...
> **やること**: Workspace 内で `hands-on/dbt/dbt_learn/dbt_project.yml` を開き、以下の内容になっていることを確認する。
> 無ければ新規作成する。
...
> **やること**: `hands-on/dbt/dbt_learn/profiles.yml` を開き確認する。
...
```bash
dbt parse --project-dir hands-on/dbt/dbt_learn
```
...
> **やること**: `hands-on/dbt/dbt_learn/models/sources.yml` を開き確認する。
