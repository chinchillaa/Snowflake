...
> **やること**: `hands-on/dbt/dbt_learn/models/staging/staging.yml` を確認する。
...
```bash
dbt test --select stg_orders --project-dir hands-on/dbt/dbt_learn
```
...
> **やること**: `hands-on/dbt/dbt_learn/tests/assert_total_price_positive.sql` を確認する。
...
```bash
dbt test --select assert_total_price_positive --project-dir hands-on/dbt/dbt_learn
```
...
`hands-on/dbt/dbt_learn/tests/assert_order_date_reasonable.sql`:
...
```bash
dbt test --select assert_order_date_reasonable --project-dir hands-on/dbt/dbt_learn
```
...
```bash
dbt build --select +fct_orders --project-dir hands-on/dbt/dbt_learn
```
...
> **やること**: `hands-on/dbt/dbt_learn/models/marts/marts.yml` を確認する。
...
```bash
dbt test --project-dir hands-on/dbt/dbt_learn
```
...
```bash
dbt docs generate --project-dir hands-on/dbt/dbt_learn
```
