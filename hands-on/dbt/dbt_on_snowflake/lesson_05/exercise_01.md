...
1. ファイル: `hands-on/dbt/dbt_learn/tests/assert_lifetime_value_non_negative.sql`
...
```bash
# テストを実行
dbt test --select assert_lifetime_value_non_negative --project-dir hands-on/dbt/dbt_learn
```
