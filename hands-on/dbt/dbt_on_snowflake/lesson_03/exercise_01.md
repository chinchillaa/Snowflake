...
1. ファイル: `hands-on/dbt/dbt_learn/models/staging/stg_regions.sql`
...
```bash
# 1. コンパイルできることを確認
dbt compile --select stg_regions --project-dir hands-on/dbt/dbt_learn

# 2. 実行
dbt run --select stg_regions --project-dir hands-on/dbt/dbt_learn
