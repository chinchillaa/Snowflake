...
> **やること**: `hands-on/dbt/dbt_learn/models/marts/dim_customers.sql` の内容を確認する。
...
> **やること**: `hands-on/dbt/dbt_learn/models/marts/agg_daily_orders.sql` を確認する。
...
> **やること**: `hands-on/dbt/dbt_learn/models/marts/fct_line_items.sql` を確認する。
...
```bash
dbt run --select fct_line_items --project-dir hands-on/dbt/dbt_learn
```
...
```bash
dbt run --select fct_line_items --full-refresh --project-dir hands-on/dbt/dbt_learn
```
