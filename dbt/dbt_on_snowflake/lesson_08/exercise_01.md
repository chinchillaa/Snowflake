...
1. ファイル: `dbt/dbt_learn/snapshots/snap_orders_ts.sql`
...
```bash
# 1. compile で SQL を確認
dbt compile --select snap_orders_ts --project-dir dbt/dbt_learn

# 2. Snapshot を実行
dbt snapshot --select snap_orders_ts --project-dir dbt/dbt_learn
```
